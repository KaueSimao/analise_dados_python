...
* **Exportação Automatizada:** Gera um arquivo Csv (`.csv`) higienizado e pronto para uso em ferramentas como Power BI.

## 🛠️ Tecnologias Utilizadas:
* **Python:** Linguagem base.
* **Pandas:** Biblioteca para manipulação e análise de tabelas.
* **Matplotlib:** Biblioteca para criação de gráficos.
* **Openpyxl:** Engine para exportação de arquivos Csv.

## 📈 Resultado Básico da Análise
![Ranking de Vendedores](grafico_ranking_vendedor.png) 
